const fs = require('fs');
const file = 'src/components/base-planner/IsometricGridBoard.tsx';
...
// Replace the image drawing logic in IsometricGridBoard
...
console.log("Patched IsometricGridBoard successfully");
